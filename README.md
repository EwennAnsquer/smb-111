...
Ce projet permet de provisionner automatiquement une infrastructure de machines virtuelles sur **n'importe quel hyperviseur Proxmox VE**, puis de configurer un cluster **K3s High Availability (3 Masters, 2 Workers)** et **FluxCD** via **Ansible**.
...
```json
{
  ...
  "gateway": "192.168.1.1",
  "masters": {
    "k3s-master-0": { "id": 6000, "ip": "192.168.1.205", "ram": 3072, "cores": 2 },
    "k3s-master-1": { "id": 6001, "ip": "192.168.1.206", "ram": 3072, "cores": 2 },
    "k3s-master-2": { "id": 6002, "ip": "192.168.1.207", "ram": 3072, "cores": 2 }
  },
  "workers": {
    "k3s-worker-0": { "id": 6003, "ip": "192.168.1.208", "ram": 4096, "cores": 2 },
    "k3s-worker-1": { "id": 6004, "ip": "192.168.1.209", "ram": 4096, "cores": 2 }
  }
}
```
